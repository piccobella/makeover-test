...
const MOCK_POSTS: CommunityPost[] = [
  {
    id: '1',
    userName: '지수',
    userAvatar: 'https://images.unsplash.com/photo-1573977465324-055ebffcb159?w=100',
    imageUrl: 'https://images.unsplash.com/photo-1573977465324-055ebffcb159?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b21hbiUyMG1ha2V1cCUyMHNlbGZpZXxlbnwxfHx8fDE3Njc4NTc0OTB8MA&ixlib=rb-4.1.0&q=80&w=1080',
    lookName: '골드 글램',
    likes: 234,
  ...
  },
  {
    id: '2',
    userName: '민지',
    userAvatar: 'https://images.unsplash.com/photo-1619249139263-cf884620e485?w=100',
    imageUrl: 'https://images.unsplash.com/photo-1619249139263-cf884620e485?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiZWF1dHklMjBtYWtldXAlMjBwb3J0cmFpdHxlbnwxfHx8fDE3Njc4NTc0OTB8MA&ixlib=rb-4.1.0&q=80&w=1080',
    lookName: '핑크 로맨틱',
    likes: 189,
  ...
  },
  {
    id: '3',
    userName: '하린',
    userAvatar: 'https://images.unsplash.com/photo-1585049303349-6680e6179692?w=100',
    imageUrl: 'https://images.unsplash.com/photo-1585049303349-6680e6179692?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWtldXAlMjB0dXRvcmlhbHxlbnwxfHx8fDE3Njc3OTg1MDN8MA&ixlib=rb-4.1.0&q=80&w=1080',
    lookName: '내추럴 데일리',
    likes: 156,
  ...
  },
  {
    ...
    userName: '수진',
    userAvatar: 'https://images.unsplash.com/photo-1573977465324-055ebffcb159?w=100',
    imageUrl: 'https://images.unsplash.com/photo-1696710869375-0ef8272dfc97?w=1080',
    lookName: '베이지 내추럴',
    likes: 142,
  ...
  },
  {
    ...
    userName: '유나',
    userAvatar: 'https://images.unsplash.com/photo-1619249139263-cf884620e485?w=100',
    imageUrl: 'https://images.unsplash.com/photo-1620459979503-c2c9815c3359?w=1080',
    lookName: '코랄 로맨틱',
    likes: 128,
  ...
  },
  {
    ...
    userName: '서연',
    userAvatar: 'https://images.unsplash.com/photo-1585049303349-6680e6179692?w=100',
    imageUrl: 'https://images.unsplash.com/photo-1636995180672-6db45200a333?w=1080',
    lookName: '라벤더 내추럴',
    likes: 95,
        ...
        {uploadModalOpen && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full">
              ...
              <div className="border-4 border-dashed border-purple-200 rounded-2xl p-12 mb-6 cursor-pointer hover:border-purple-400 transition-colors">
